    ...
    <div id="settingPanelAccordion">
        ...
        <div>
            ...
            <div class="SettingPanelRow" id="FontRow">
                ...
                <asp:DropDownList runat="server" ID="FontSelector" ClientIDMode="Static" onchange="TextPlayerManager.CFT()" Style="float: right" />
            </div>
        ...
        <div>
            <div class="SettingPanelRow" id="ThemeRow">
                ...
                <asp:DropDownList runat="server" Style="float: right;" ID="ThemeSelector" ClientIDMode="Static" onchange="SettingPanelFunctions.CT(this.value)" />
            </div>
            <div class="SettingPanelRow" id="HighlightRow">
                ...
                <asp:ColorPickerExtender ID="ColorPickerExtender1" runat="server" TargetControlID="HighlightColor" PopupButtonID="PopupButton" SampleControlID="ColorDisplay" OnClientColorSelectionChanged="TextPlayerManager.CHC"></asp:ColorPickerExtender>
            </div>
